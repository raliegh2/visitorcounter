...
type OrganizationSettingsRow = {
  organization_id: string; visitor_retention_months: number; contact_retention_months: number;
  attendance_retention_months: number; audit_retention_months: number; not_seen_days: number;
  require_service_assignment: boolean; updated_at: string; updated_by: string | null;
};
type VisitorRow = {
  id: string; organization_id: string; full_name: string; preferred_name: string | null; first_visit_date: string;
  optional_contact: string | null; contact_consent: boolean; active: boolean; anonymized_at: string | null;
...
type MemberRow = { id: string; organization_id: string; first_name: string; last_name: string; email: string | null; phone: string | null; address: string | null; membership_status: string; last_contact_at: string | null; imported_at: string | null; import_batch_id: string | null; created_by: string; created_at: string; updated_at: string };
type CareNoteRow = { id: string; organization_id: string; visitor_id: string | null; member_id: string | null; note_text: string; status: string; visibility: string; created_by: string; created_at: string; updated_at: string };
type VisitRecordRow = { id: string; organization_id: string; visitor_id: string | null; member_id: string | null; visited_at: string; visited_by: string; outcome: string; summary: string | null; created_at: string };
type PastorApplicationRow = { profile_id: string; organization_id: string; church_name: string; pastor_name: string; district: string; denomination: string; church_phone: string; submitted_at: string; reviewed_at: string | null; reviewed_by: string | null; verification_notes: string | null };
...
export type Database = {
  public: {
    Tables: {
      ...
      user_profiles: {
        Row: UserProfileRow;
        Insert: { id: string; organization_id: string; display_name: string; role?: AppRole; active?: boolean; auth_not_before?: string; requested_role?: "administrator" | "usher" | "pastor"; role_status?: "pending" | "approved" | "rejected"; clerk_user_id?: string | null; created_at?: string; updated_at?: string };
        Update: Partial<UserProfileRow>; Relationships: [];
      };
      ...
      members: { Row: MemberRow; Insert: { id?: string; organization_id: string; first_name: string; last_name: string; email?: string | null; phone?: string | null; address?: string | null; membership_status?: string; last_contact_at?: string | null; imported_at?: string | null; import_batch_id?: string | null; created_by: string; created_at?: string; updated_at?: string }; Update: Partial<MemberRow>; Relationships: [] };
      care_notes: { Row: CareNoteRow; Insert: { id?: string; organization_id: string; visitor_id?: string | null; member_id?: string | null; note_text: string; status?: string; visibility?: string; created_by: string; created_at?: string; updated_at?: string }; Update: Partial<CareNoteRow>; Relationships: [] };
      visit_records: { Row: VisitRecordRow; Insert: { id?: string; organization_id: string; visitor_id?: string | null; member_id?: string | null; visited_at?: string; visited_by: string; outcome?: string; summary?: string | null; created_at?: string }; Update: Partial<VisitRecordRow>; Relationships: [] };
      pastor_applications: { Row: PastorApplicationRow; Insert: { profile_id: string; organization_id: string; church_name: string; pastor_name: string; district: string; denomination: string; church_phone: string; submitted_at?: string; reviewed_at?: string | null; reviewed_by?: string | null; verification_notes?: string | null }; Update: Partial<PastorApplicationRow>; Relationships: [] };
    };
