  ...
  public: {
    Tables: {
      ...
      service_assignments: {
        ...
        Insert: ServiceAssignmentRow;
        Update: Partial<ServiceAssignmentRow>;
        Relationships: [];
      };
      attendance: {
        Row: AttendanceRow;
    ...
    Functions: {
      ...
      search_visitors: {
        Args: { p_query: string; p_service_id: string };
        Returns: Array<{
          id: string;
          full_name: string;
          preferred_name: string | null;
      ...
      register_visitor_and_check_in: {
        Args: {
          ...
          p_optional_contact: string | null;
      ...
      check_in_visitor: {
        Args: { p_visitor_id: string; p_service_id: string };
        Returns: string;
      };
      current_attendance: {
      ...
      create_service: {
        Args: { p_service_name: string; p_service_date: string; p_start_time: string };
        Returns: string;
      };
      set_service_assignment: {
        Args: { p_service_id: string; p_user_id: string; p_assigned: boolean };
        Returns: undefined;
      };
      attendance_summary: {
      ...
      update_organization_settings: {
        Args: {
          p_visitor_retention_months: number;
          p_contact_retention_months: number;
          p_attendance_retention_months: number;
          p_audit_retention_months: number;
          p_not_seen_days: number;
      ...
      retention_preview: {
        ...
        Returns: Array<{
          ...
          eligible_contact_records: number;
          eligible_attendance_records: number;
        }>;
      };
      apply_visitor_retention: {
