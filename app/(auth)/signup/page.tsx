  ...
  return (
    <main className="login-shell">
      <section className="login-hero">
        <div className="eyebrow" style={{ color: "#ded9fb" }}>Role-based ministry access</div>
        <h1>Join the workspace with the responsibilities assigned to you.</h1>
        <p>
          Choose Usher, Pastor, or Administrator. Usher access begins after email confirmation;
          Pastor and Administrator requests are reviewed before protected ministry records become available.
        </p>
      ...
      <section className="login-panel">
        <div className="login-card role-signup-card">
          <div className="brand auth-brand">
            ...
            <div><strong>Church Care Hub</strong><span>Staff access</span></div>
          </div>
          <h2>Create account or request access</h2>
          <p className="muted">Use your own email address and select the role you are responsible for.</p>
          ...
          <form action={requestStaffAccess}>
            ...
            <fieldset className="role-picker">
              ...
              <label className="role-option">
                ...
                <span>
                  <strong>Usher</strong>
                  <small>Visitor registration, check-in, visitor support notes, and visitor visit tracking.</small>
                </span>
              </label>
              <label className="role-option">
                ...
                <span>
                  ...
                  <small>Visitor and member records, Excel imports, care notes, and ministry visits.</small>
                </span>
              </label>
              <label className="role-option">
                <input type="radio" name="requestedRole" value="administrator" />
                <span>
                  <strong>Administrator</strong>
                  <small>Every ministry section plus users, approvals, reporting, audit, and privacy controls.</small>
                </span>
              </label>
            </fieldset>
            ...
            <details className="pastor-details">
              ...
              <div className="form-grid">
                ...
                <div className="field"><label htmlFor="churchPhone">Church phone</label><input id="churchPhone" name="churchPhone" type="tel" maxLength={40} /></div>
              </div>
            </details>
